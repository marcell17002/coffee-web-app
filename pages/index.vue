<template>
  <div>
    ...
    <div class="max-w-screen-xl mx-auto">
      ...
      <div class="md:pt-32 my-20  mx-5  justify-center">
        <h1 class="text-xl md:text-3xl xl:px-18 md:px-14  text-gray-700 font-bold md:text-center ">
          Starbucks adalah <span class="text-green-700 ">solusi lengkap </span> penikmat kopi produk anak bangsa. Kopi yang menciptakan <span class="text-green-700 font">ciri </span> khas nikmatnya kopi Indonesia yang melalui beberapa tahapan sederhana yang menambah <span class="text-green-700 font"> cita rasa </span> kopi buatan Indonesia.
        </h1>
      </div>

      <div class="md:pt-44 my-20 mx-5 pb-32  justify-center">
        ...
        <div class=" md:flex md:justify-evenly flex-row  md:mx-20  md:mt-32">
          <div class="md:h-64 md:w-44 h-80 lg:w-52 mt-20 md:-mt-0 ">
            ...
            <h1 class="text-sm  md:text-md mt-2 text-gray-700  font-normal md:text-justify">
              Lorem Ipsum is simply dummy text of the Lorem Ipsum is simply dummy text of the text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
            </h1>
          </div>
          <div class="md:h-64 md:w-44 lg:w-52 h-80 mt-40 md:ml-2 lg:-ml-5 md:-mt-0 ">
            <img class=" h-full w-full md:h-full rounded-2xl  object-cover " src="~/assets/img/home-step-2.jpg">
            <h1 class="text-gray-700 text-lg font-semibold text-center pt-5">
              Pengeringan Biji Kopi Setelah Dipetik
            </h1>
            <h1 class="text-sm  md:text-md mt-2 text-gray-700  font-normal md:text-justify">
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
            </h1>
    ...
    <div class="flex justify-end md:pt-52">
      <div class=" absolute z-10 pr-5 pt-12 md:pr-12 xl:pr-32  xl:pt-24 2xl:pt-40">
        <h1 class="text-right text-white font-semibold text-xl md:text-2xl lg:text-4xl xl:text-4xl ">
          Sejahterakan petani kopi Indonesia
        </h1>
        <h1 class="text-right text-white font-semibold text-xl md:text-2xl lg:text-4xl xl:text-4xl ">
          maju bersama UMKM
        </h1>
        <h1 class="text-right text-white font-semibold text-xl md:text-2xl lg:text-4xl xl:text-4xl  pt-36 md:pt-52 lg:pt-80">
          #KopiAnakBangsa
        </h1>
      </div>
